...
public class TransactionEntity {
    ...
    public TransactionEntity(String number, Double amount, String sign, LocalDate date, String comment, Category category, Project project) {
        this.number = number;
        this.amount = amount;
        this.sign = sign;
        this.date = date;
    ...
    public TransactionEntity(String number) {
        this.number = number;
    }
